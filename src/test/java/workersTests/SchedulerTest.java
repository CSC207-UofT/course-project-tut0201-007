    ...
    public void testGenerateTST105Schedule() {
        ...
        String expected =
                "Schedule: \n"
                    ...
                    + "|                          |                          |                    "
                    + "      |                          |                          |\n"
                    + "| 10:00-11:00, WI 1016     |                          | 10:00-11:00, WI"
                    + " 1016     |                          | 10:00-11:00, WI 1016     |\n"
                    + "|                          |                          |                    "
                    + "      |                          |                          |\n"
                    + "+--------------------------+--------------------------+--------------------------+--------------------------+--------------------------+\n"
                    + "|                          |                          |                    "
    ...
    public void testGenerateMultiCourseSchedule() {
        ...
        String expected =
                "Schedule: \n"
                    ...
                    + "|                          |                          |                    "
                    + "      |                          |                          |\n"
                    + "| 09:00-10:00, ONLINE      |                          | 09:00-11:00, ONLINE"
                    + "      |                          |                          |\n"
                    + "|                          |                          |                    "
                    + "      |                          |                          |\n"
                    + "+--------------------------+--------------------------+--------------------------+--------------------------+--------------------------+\n"
    ...
    public void testGenerateYearCourseSchedule() {
        ...
        String expected =
                "Schedule: \n"
                    ...
                    + "|                          |                          |                    "
                    + "      |                          |                          |\n"
                    + "| 09:00-10:00, LM 159      | 09:00-10:00, LM 159      |                    "
                    + "      | 09:00-10:00, LM 159      |                          |\n"
                    + "|                          |                          |                    "
                    + "      |                          |                          |\n"
                    + "+--------------------------+--------------------------+--------------------------+--------------------------+--------------------------+\n"
