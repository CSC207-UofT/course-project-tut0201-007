...
public class Scheduler {
     ...
     */
    public List<Schedule> permutationScheduler(List<Course> newCourses) throws CloneNotSupportedException {
     ...
     */
    private List<Schedule> extendPermutations(Course c, Schedule s) throws CloneNotSupportedException {
