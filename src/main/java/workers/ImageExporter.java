...
public class ImageExporter extends Exporter {
    ...
    private Color getColor(int sessionNum) {
        switch (sessionNum) {
            ...
            case 1:
                return Color.decode("#bfef45");
            case 2:
                return Color.decode("#42d4f4");
            case 3:
                return Color.decode("#fabed4");
            case 4:
                return Color.decode("#ffd8b1");
            case 5:
                return Color.decode("#fffac8");
            case 6:
                return Color.decode("#aaffc3");
            case 7:
                return Color.decode("#dcbeff");
            case 8:
                return Color.decode("#f58231");
            case 9:
